...
export async function POST(req) {
  ...
  const mailOptions = {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #172554;">
      <div style="background-color: #172554; padding: 30px;">
        ...
        <p style="color: #ffffff; line-height: 1.3; opacity: 0.9;">
        ...
        <br>
        - This is an automated message. <strong>PLEASE DO NOT REPLY</strong>
        </p>
        <p style="color: #ffffff; font-size: 10px; text-align: center; margin-top: 20px; opacity: 0.7;">
        © JRMSU Tabulation System by Creatives Committee, CoderStation, codeGehan, duduyMayo, markLAN
        </p>
      </div>
    </div>
    `
